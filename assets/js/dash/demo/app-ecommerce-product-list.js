    ...
    if (dt_product_table.length) {
        var dt_products = dt_product_table.DataTable({
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        var stockSwitchObj = {
                            Out_of_Stock: '<label class="switch switch-primary switch-sm">' +
                                ...
                                '</span>' +
                                '</label>',
                            In_Stock: '<label class="switch switch-primary switch-sm">' +
            ...
            buttons: [{
                ...
                {
                    text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Adicionar Cliente</span>',
